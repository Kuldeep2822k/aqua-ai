...
jest.mock('../src/db/connection', () => {
  const createMockBuilder = () => {
    ...
    const builder = {
      ...
      whereNotNull: jest.fn(function () {
        methods.push('whereNotNull');
        return this;
      }),
      avg: jest.fn(function () {
        methods.push('avg');
        return this;
      }),
      orderBy: jest.fn(function () {
        methods.push('orderBy');
        return this;
      }),
      ...
      then: jest.fn((resolve) => {
        ...
        if (methods.includes('limit') && methods.includes('orderBy')) {
          return Promise.resolve([
            { measurement_date: '2023-10-27T00:00:00.000Z' },
          ]).then(resolve);
        }
