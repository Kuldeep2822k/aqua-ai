...
exports.up = async function (knex) {
  ...
  await knex.schema.createTable('water_quality_readings', function (table) {
    ...
    table.integer('parameter_id').unsigned().references('id').inTable('water_quality_parameters').onDelete('CASCADE');
  ...
  await knex('water_quality_parameters').insert([
    {parameter_code: 'BOD', parameter_name: 'Biochemical Oxygen Demand', unit: 'mg/L', safe_limit: 3.0, moderate_limit: 6.0, high_limit: 10.0, critical_limit: 15.0, description: 'Measures organic pollution in water'},
    {parameter_code: 'TDS', parameter_name: 'Total Dissolved Solids', unit: 'mg/L', safe_limit: 500, moderate_limit: 1000, high_limit: 1500, critical_limit: 2000, description: 'General measure of water purity'},
    {parameter_code: 'pH', parameter_name: 'pH Level', unit: '', safe_limit: 6.5, moderate_limit: 8.5, high_limit: 9.0, critical_limit: 10.0, description: 'Acidity/alkalinity measure'},
    {parameter_code: 'DO', parameter_name: 'Dissolved Oxygen', unit: 'mg/L', safe_limit: 6.0, moderate_limit: 4.0, high_limit: 2.0, critical_limit: 1.0, description: 'Oxygen available for aquatic life'},
    {parameter_code: 'Lead', parameter_name: 'Lead', unit: 'mg/L', safe_limit: 0.01, moderate_limit: 0.05, high_limit: 0.1, critical_limit: 0.2, description: 'Heavy metal contamination'},
    {parameter_code: 'Mercury', parameter_name: 'Mercury', unit: 'mg/L', safe_limit: 0.001, moderate_limit: 0.005, high_limit: 0.01, critical_limit: 0.02, description: 'Toxic heavy metal'},
    {parameter_code: 'Coliform', parameter_name: 'Coliform Count', unit: 'MPN/100ml', safe_limit: 2.2, moderate_limit: 10, high_limit: 50, critical_limit: 100, description: 'Bacterial contamination indicator'},
    {parameter_code: 'Nitrates', parameter_name: 'Nitrates', unit: 'mg/L', safe_limit: 45, moderate_limit: 100, high_limit: 200, critical_limit: 300, description: 'Agricultural runoff indicator'}
  ]);
};
