...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (risk_level) {
      // Calculate risk level from value - simplified mapping
      // This would need proper thresholds per parameter in production
    }
...
function calculateRiskFromValue(parameter, value) {
  const thresholds = {
    ...
    'DO': { low: 6, medium: 4, high: 2 }, // Inverted - higher is better
