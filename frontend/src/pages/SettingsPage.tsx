            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="button"
                    onClick={() => !savingSection && handleSave('profile')}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="button"
                    onClick={() => !savingSection && handleSave('preferences')}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="button"
                    onClick={() => !savingSection && handleSave('thresholds')}
          ...
          {activeSection === 'security' && (
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-red-200 dark:border-red-900/50 shadow-sm transition-colors duration-200">
                ...
                <button
                  type="button"
                  onClick={() => !isDeletingAccount && handleDeleteAccount()}
          ...
          {activeSection === 'appearance' && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between items-center pt-4">
                ...
                <button
                  type="button"
                  onClick={() => !savingSection && handleSave('appearance')}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="button"
                    onClick={() => !savingSection && handleSave('settings')}
