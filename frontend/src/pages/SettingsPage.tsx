import { User, Bell, Shield, Database, Sliders, Globe, Palette, Download, Trash2, Save, Key, Mail, Phone, MapPin, AlertCircle } from 'lucide-react';
...
const parameterThresholds = [
  { id: 'bod', name: 'BOD (Biological Oxygen Demand)', unit: 'mg/L', current: 3.0, safe: 3.0, critical: 5.0 },
  { id: 'ph', name: 'pH Level', unit: '', current: 8.5, safe: 8.5, critical: 9.5 },
  { id: 'tds', name: 'TDS (Total Dissolved Solids)', unit: 'ppm', current: 500, safe: 500, critical: 1000 },
  { id: 'do', name: 'DO (Dissolved Oxygen)', unit: 'mg/L', current: 5.0, safe: 5.0, critical: 3.0 },
  { id: 'turbidity', name: 'Turbidity', unit: 'NTU', current: 10, safe: 10, critical: 50 },
  { id: 'lead', name: 'Lead', unit: 'mg/L', current: 0.01, safe: 0.01, critical: 0.1 },
];
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-8 py-8">
          ...
          {activeSection === 'notifications' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Choose how you want to receive alerts and updates</p>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Alert Channels</h3>
                
                <div className="space-y-4">
                  {[
                    { key: 'emailAlerts', icon: Mail, label: 'Email Alerts', sub: 'Receive alerts via email', bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-600 dark:text-blue-400' },
                    { key: 'smsAlerts', icon: Phone, label: 'SMS Alerts', sub: 'Receive critical alerts via SMS', bg: 'bg-green-100 dark:bg-green-900/30', text: 'text-green-600 dark:text-green-400' },
                    { key: 'pushNotifications', icon: Bell, label: 'Push Notifications', sub: 'Receive browser notifications', bg: 'bg-purple-100 dark:bg-purple-900/30', text: 'text-purple-600 dark:text-purple-400' }
                  ].map((item) => (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Report Preferences</h3>
                
                <div className="space-y-4">
                  {[
                    { key: 'criticalOnly', label: 'Critical Alerts Only', sub: 'Only notify for critical severity alerts' },
                    { key: 'dailySummary', label: 'Daily Summary', sub: 'Receive daily activity summary at 9:00 AM' },
                    { key: 'weeklyReport', label: 'Weekly Report', sub: 'Receive comprehensive weekly report' }
                  ].map((item) => (
                    <div key={item.key} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white">{item.label}</div>
          ...
          {activeSection === 'thresholds' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Alert Thresholds</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">Configure water quality parameter thresholds for alerts</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                <div className="flex items-center gap-2 mb-6 p-3 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg">
                  ...
                  <p className="text-sm text-yellow-800 dark:text-yellow-200">Changes to thresholds will affect alert generation. Use caution when modifying these values.</p>
                </div>

                <div className="space-y-6">
                  {parameterThresholds.map((param) => (
                    <div key={param.id} className="p-5 bg-gradient-to-r from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <h4 className="font-semibold text-gray-900 dark:text-white">{param.name}</h4>
                          <p className="text-sm text-gray-500 dark:text-gray-400">Unit: {param.unit || 'N/A'}</p>
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Current Value</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Safe Threshold</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Critical Threshold</label>
                          <input
                            type="number"
          ...
          {activeSection === 'security' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Manage your account security and authentication</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-red-200 dark:border-red-900/50 shadow-sm transition-colors duration-200">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Irreversible and destructive actions</p>
          ...
          {activeSection === 'data' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Manage your data, exports, and storage</p>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Data Export</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Download your data in various formats</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="p-4 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">All monitoring data</div>
                  </button>
                  <button className="p-4 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">Formatted spreadsheet</div>
                  </button>
                  <button className="p-4 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600 dark:text-gray-400">12.4 GB of 50 GB used</span>
                    <span className="text-sm font-medium text-gray-900 dark:text-white">24.8%</span>
                  </div>
                  <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-blue-500 to-purple-500 rounded-full" style={{ width: '24.8%' }}></div>
                  </div>
                </div>
          ...
          {activeSection === 'appearance' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Appearance</h2>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  >
                    <div className="w-full h-20 bg-gradient-to-r from-white via-gray-400 to-gray-900 rounded-lg mb-3 flex items-center justify-center border border-gray-200 dark:border-gray-700">
                      <div className="text-xs text-gray-600 dark:text-gray-300 mix-blend-difference">Auto</div>
                    </div>
                    <div className="font-medium text-gray-900 dark:text-white flex items-center justify-center gap-2">
                      Auto
                      {theme === 'auto' && (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-blue-700 dark:text-blue-300">
                        {theme === 'light' && 'Light theme provides a clean and bright interface'}
                        {theme === 'dark' && 'Dark theme is easier on the eyes in low-light conditions'}
                        {theme === 'auto' && 'Auto theme switches between light and dark based on system preferences'}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Adjust spacing and content density</p>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">More spacing between elements for easier reading</div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Less spacing to fit more content on screen</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-purple-700 dark:text-purple-300">
                        {density === 'comfortable' && 'Comfortable density provides better readability with generous spacing'}
                        {density === 'compact' && 'Compact density maximizes screen space for data-heavy interfaces'}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Color Accent</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Choose your preferred accent color (Coming Soon)</p>
                
                <div className="grid grid-cols-6 gap-3">
                  {['bg-blue-500', 'bg-purple-500', 'bg-green-500', 'bg-red-500', 'bg-orange-500', 'bg-pink-500'].map((color, index) => (
                    <button
                      key={index}
          ...
          {activeSection === 'system' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">System Settings</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">Configure system-level preferences</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm transition-colors duration-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <span className="text-sm font-medium text-gray-900 dark:text-white">2.4.1</span>
                  </div>
                  <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Last Updated</span>
                    <span className="text-sm font-medium text-gray-900 dark:text-white">January 20, 2026</span>
                  </div>
                  <div className="flex items-center justify-between py-2">
                    <span className="text-sm text-gray-600 dark:text-gray-400">License</span>
                    <span className="text-sm font-medium text-gray-900 dark:text-white">Enterprise</span>
                  </div>
                </div>
              </div>
            </div>
