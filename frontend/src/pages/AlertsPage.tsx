      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {selectedAlertData ? (
          <div className="flex-1 bg-white dark:bg-gray-800 overflow-y-auto transition-colors duration-200">
            <div className={`p-8 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-br ${
              (severityConfig[selectedAlertData.severity as keyof typeof severityConfig] ||
              ...
              <div className="max-w-4xl mx-auto">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <span className={`w-3 h-3 ${
                        (severityConfig[selectedAlertData.severity as keyof typeof severityConfig] ||
                          severityConfig.medium).badge
                      } rounded-full animate-pulse`}></span>
                      <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {selectedAlertData.alert_type} • {selectedAlertData.parameter}
                      </h1>
                    </div>
                    <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-300">
                      <div className="flex items-center gap-1">
                        <MapPin className="w-4 h-4" />
                        {selectedAlertData.location_name}, {selectedAlertData.state}
                      </div>
                      <div className="flex items-center gap-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className={`px-4 py-2 rounded-xl bg-gradient-to-r ${
                    (severityConfig[selectedAlertData.severity as keyof typeof severityConfig] ||
                      severityConfig.medium).gradient
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-gray-200 mt-1">{selectedAlertData.message}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Values</label>
                      <p className="text-gray-900 dark:text-gray-200 mt-1">
                        Actual: {selectedAlertData.actual_value ?? 'N/A'} • Threshold:{' '}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-200">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-4 border border-red-200 dark:border-red-800">
                      ...
                      <div className="text-lg font-bold text-red-900 dark:text-red-100">{selectedAlertData.actual_value ?? 'N/A'}</div>
                    </div>
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-600/50 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                      ...
                      <div className="text-lg font-bold text-gray-900 dark:text-gray-100">{selectedAlertData.threshold_value ?? 'N/A'}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-gray-200">{selectedAlertData.location_name}</span>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
