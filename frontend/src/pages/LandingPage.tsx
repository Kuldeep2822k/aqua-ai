...
function HeroSection({ onEnterApp, onViewMap }: LandingPageProps) {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <header className="relative z-50 flex items-center justify-between px-5 py-5 md:px-8">
        <button
          type="button"
          onClick={onEnterApp}
...
function SignalsSection({ onEnterApp, onViewMap }: LandingPageProps) {
  return (
    <section
      id="signals"
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <p className="max-w-xl text-sm leading-6 text-white/54">
            ...
            tracked, what crosses threshold, and how a public data layer becomes
            an operational risk console.
          </p>
        </div>
...
function SystemSection({ onEnterApp }: Pick<LandingPageProps, 'onEnterApp'>) {
  return (
...
export function LandingPage({ onEnterApp, onViewMap }: LandingPageProps) {
  return (
    <main className="min-h-screen bg-black text-white">
      <HeroSection onEnterApp={onEnterApp} onViewMap={onViewMap} />
      <SignalsSection onEnterApp={onEnterApp} onViewMap={onViewMap} />
      <CoverageSection />
      <ParametersSection />
      <SystemSection onEnterApp={onEnterApp} />
    </main>
  );
}
