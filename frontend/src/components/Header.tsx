            ...
            <button
              ...
              className={
                currentPage === 'dashboard'
                  ? 'text-blue-500 dark:text-blue-400 font-medium focus-visible:outline-none focus-visible:ring-2 rounded-md'
                  : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white focus-visible:outline-none focus-visible:ring-2 rounded-md'
              }
            >
              Dashboard
            </button>
