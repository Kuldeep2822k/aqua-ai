        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button
              ...
              className={`focus-visible:outline-none focus-visible:ring-2 rounded-md px-2 py-1 -ml-2 ${
            ...
            <button
              ...
              className={`focus-visible:outline-none focus-visible:ring-2 rounded-md px-2 py-1 ${
                currentPage === 'map'
                  ? 'text-blue-500 dark:text-blue-400 font-medium'
                  : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
              }`}
            ...
            <button
              ...
              className={`focus-visible:outline-none focus-visible:ring-2 rounded-md px-2 py-1 -mr-2 ${
